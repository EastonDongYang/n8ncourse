...
const stats = [
  { name: 'Active Users', value: '25,000+' },
  { name: 'Workflow Templates', value: '500+' },
  { name: 'Tutorials Published', value: '200+' },
  { name: 'Community Members', value: '15,000+' },
]
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white">n8ncourse.org</h3>
                <p className="text-sm text-gray-400">Master Workflow Automation</p>
              </div>
            </div>
            <p className="text-sm leading-6 text-gray-300">
              Learn n8n workflow automation from beginner to advanced. Join thousands of automation enthusiasts building powerful workflows.
            </p>
            
            {/* Statistics */}
            <div className="grid grid-cols-2 gap-4">
              {stats.map((stat) => (
                <div key={stat.name} className="border-l-2 border-primary-600 pl-4">
        ...
        <div className="mt-16 border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-sm text-gray-400">Get the latest n8n tutorials and automation tips.</p>
            </div>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
            &copy; 2024 n8ncourse.org. All rights reserved. Built with ❤️ for the n8n community.
          </p>
        </div>
      </div>
    </footer>
